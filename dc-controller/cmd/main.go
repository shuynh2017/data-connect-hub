...
func main() {
	...
	if err := (&controller.DataConnectServiceReconciler{
		...
		RestImage: controller.EnvOrDefault(
			...
			"quay.io/opendatahub/odh-data-connect-hub-rest@sha256:4240333c67c7c1fb0f64638789b1c83b6d06638b102150b93229255d9a10bc3b", //nolint:lll
		),
		FlightImage: controller.EnvOrDefault(
			"RELATED_IMAGE_ODH_DATA_CONNECT_HUB_FLIGHT_IMAGE",
			"quay.io/opendatahub/odh-data-connect-hub-flight@sha256:b13af13b98eea740a41c70564e010096e754e840be6a49bb446661c87eb7a423", //nolint:lll
		),
